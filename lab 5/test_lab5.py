...
def test_test_data_file_exists():
    assert os.path.exists("lab1/test/test_data.csv"), "File lab1/test/test_data.csv does not exist."


# Функция проверки существования файла lab1/train/train_data.csv
def test_train_data_file_exists():
    assert os.path.exists("lab1/train/train_data.csv"), "File lab1/train/train_data.csv does not exist."
